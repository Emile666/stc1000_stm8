#line 1 "D:\\ownCloud\\Programming\\stc1000_stm8\\src\\eep.c"
/*==================================================================
  File Name    : eep.c
  Author       : Emile
  ------------------------------------------------------------------
...
#line 27 "D:\\ownCloud\\Programming\\stc1000_stm8\\src\\eep.h"
#line 1 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.0\\stm8\\inc\\c\\stdint.h"
/* stdint.h standard header */
/* Copyright 2003-2010 IAR Systems AB.  */
...
#line 29 "D:\\ownCloud\\Programming\\stc1000_stm8\\src\\eep.h"
...
#line 26 "D:\\ownCloud\\Programming\\stc1000_stm8\\src\\eep.c"
...
void eeprom_write_config(uint8_t eeprom_address,uint16_t data)
{
    ...
    while (FLASH_IAPSR_bit . DUL == 0) ; // wait until EEPROM is unlocked
    *address++ = (char)((data >> 8) & 0xff); // write MSB
    *address   = (char)(data & 0xff);        // write LSB
    FLASH_IAPSR_bit . DUL = 0;                     // write-protect EEPROM again
} // eeprom_write_config()
