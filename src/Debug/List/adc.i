#line 1 "D:\\Dropbox\\Programming\\Github\\stc1000_stm8\\src\\adc.c"
/*==================================================================
  File Name    : adc.c
  Author       : Emile
  ------------------------------------------------------------------
 ...
 * Consult your license regarding permissions and restrictions.
V5.04:0576 */
#line 28 "D:\\Dropbox\\Programming\\Github\\stc1000_stm8\\src\\adc.h"
...
#line 29 "D:\\Dropbox\\Programming\\Github\\stc1000_stm8\\src\\adc.h"
...
#line 30 "D:\\Dropbox\\Programming\\Github\\stc1000_stm8\\src\\adc.h"
...
#line 26 "D:\\Dropbox\\Programming\\Github\\stc1000_stm8\\src\\adc.c"
...
uint16_t read_adc(uint8_t ch)
{
    ...
    ADC_CSR_bit . CH    = ch;         // Select ADC channel
    ADC_TDRL      = 0x18;       // Disable Schmitt-Trigger of ADC channels 3 and 4
    ADC_CR1_bit . ADON  = 1;          // Turn ADC on, note a 2nd set is required to start the conversion.
    ADC_CR3_bit . DBUF  = 0;
    ADC_CR2_bit . ALIGN = 1;          // Data is right aligned.
    while (ADC_CR1_bit . ADON == 0) ; // wait until ADC is turned on

    for (i = 0; i < (16); i++)
    {
        ADC_CR1_bit . ADON  = 1;          // This 2nd write starts the conversion.
        while (ADC_CSR_bit . EOC == 0) ;  // wait until conversion is complete
        ...
        ADC_CSR_bit . EOC  = 0;	    // Reset conversion complete flag
    } // for
    ADC_CR1_bit . ADON = 0;               // Disable the ADC
    result2     /= (16);         // Calculate average of samples
    return result2;
} // read_adc()
...
int16_t ad_to_temp(uint16_t adfilter, _Bool *err)
{
	uint8_t i;
	long    temp = 32;
	uint8_t a = ((adfilter >> ((6)-1)) & 0x3f); // Lower 6 bits
	uint8_t b = ((adfilter >> ((6)+5)) & 0x1f); // Upper 5 bits
